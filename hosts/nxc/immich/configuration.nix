...
let
  immichPackage = inputs.nixpkgs-immich.legacyPackages.${pkgs.stdenv.hostPlatform.system}.immich;
in
{
  imports = [
  ...
  services.immich = {
    enable = true;
    package = assert immichPackage.version == "3.1.0"; immichPackage;
    host = "0.0.0.0";
    # port = 2283;
    openFirewall = true;
